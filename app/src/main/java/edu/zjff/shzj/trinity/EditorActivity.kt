...
import edu.zjff.shzj.trinity.editor.*
import edu.zjff.shzj.trinity.entity.*
import edu.zjff.shzj.trinity.entity.Filter
import edu.zjff.shzj.trinity.fragment.MusicFragment
import edu.zjff.shzj.trinity.listener.OnEffectTouchListener
import edu.zjff.shzj.trinity.view.*
import edu.zjff.shzj.ui.Activity_InsertNewVideo
import edu.zjff.shzj.util.GlideEngine
import kotlinx.android.synthetic.main.activity_insertvideo.*
...
//    println("progress: $progress")
  ...
  override fun onExportComplete() {
    ...
    startActivity(Intent(this, Activity_InsertNewVideo::class.java))
    finish()
  }
