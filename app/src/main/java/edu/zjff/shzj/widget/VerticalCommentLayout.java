...
public class VerticalCommentLayout extends LinearLayout implements
    ...
    private void init() {
        ...
        mCommentVerticalSpace = SizeUtils.dp2px(getContext(),2f);
    ...
    private void bindViewData(View view, final SecondLevelBean content) {
       ...
       /* ImageView iv_like = view.findViewById(R.id.iv_like);
        ...
        TextView commid =view.findViewById(R.id.commId);
        commid.setText(content.getId());
                Glide.with(iv_header.getContext())
                        .load(Constant.BASE1+"images/avatar/"+content.getHeadImg()).placeholder(R.mipmap.shzj_avatar_default).into(iv_header);
...
*/
        ...
        rl_group.setOnLongClickListener(new OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (onCommentItemClickListener != null)
                    onCommentItemClickListener.onItemLongClick(v, content, position);
                return true;
            }
        });
        ...
        if (!TextUtils.isEmpty(atSomeone)) {
            ...
            builder.setSpan(new TextClickSpans() {
                ...
                public void onClick(@NonNull View widget) {
                    Toast.makeText(getContext(), atSomeone + " id: " + id, Toast.LENGTH_LONG).show();
                }
    ...
    public interface CommentItemClickListener {
        ...
        void onItemLongClick(View view, SecondLevelBean bean, int position);
